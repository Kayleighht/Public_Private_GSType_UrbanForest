...
#create csv file
write.csv(per.site.total.ab, "/home/kayleighhutttaylor/sr.sitetotals.ab.csv")
...
pie.tot.sites
##push out to csv
write.csv(pie.tot.sites, "/home/kayleighhutttaylor/pie.site.totals.csv")
