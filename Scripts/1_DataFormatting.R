...
write.csv(wide.pr, "/home/kayleighhutttaylor/yards.sp.wide.csv", row.names = FALSE)
...
#write as csv so that I can pull it for other scripts/analysis
write.csv(wide.row, "/home/kayleighhutttaylor/row.wide.matrix.csv", row.names = FALSE)
...
#write as csv so that I can pull it for other scripts/analysis
write.csv(wide.park,"/home/kayleighhutttaylor/parks.wide.matrix.csv", row.names = FALSE)
...
#write as csv so that I can pull it for other scripts/analysis
write.csv(ar.park.w, "/home/kayleighhutttaylor/site.park.wide.matrix.csv", row.names = FALSE)
...
#write as csv so that I can pull it for other scripts/analysis
write.csv(wide.in, "/home/kayleighhutttaylor/in.wide.matrix.csv", row.names = FALSE)
...
#write as csv so that I can pull it for other scripts/analysis
write.csv(in.ar.w, "/home/kayleighhutttaylor/site.in.wide.matrix.csv", row.names = FALSE)
...
#write as csv so that I can pull it for other scripts/analysis
write.csv(total.sp.table, "/home/kayleighhutttaylor/allgs.matrix.csv", row.names = FALSE)
...
write.csv(site.sp.tot.mat, "/home/kayleighhutttaylor/site.sp.tot.mat.csv", row.names = FALSE)
...
pie.site.means <- LMM.Meta %>%
  ...
  summarise(
    PIE.site = mean(PIE))
pie.site.means
write.csv(pie.site.means, "/home/kayleighhutttaylor/pie.site.means.csv", row.names = FALSE)
...
ab.site.means<- LMM.Meta %>%
  ...
  summarise(
    ab.site = mean(Abund))
ab.site.means
write.csv(ab.site.means, "/home/kayleighhutttaylor/ab.site.means.csv", row.names = FALSE)
