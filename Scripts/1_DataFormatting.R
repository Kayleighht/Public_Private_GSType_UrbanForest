#### Load Packages
Packages.1 <- c("readr", "vegan", "dplyr", "plyr", "tidyr", "psych", "benthos", "mobr", "dplyr")
...
pr.data<- read.csv("Input/Clean_Private_Cu.csv")
...
write.csv(wide.pr, "Output/yards.sp.wide.csv", row.names = FALSE)
...
row.data<- read.csv("Input/Clean_ROW_Cu.csv")
#creating a data table that sorts species codes and site code
...
#write as csv so that I can pull it for other scripts/analysis
write.csv(wide.row, "Output/row.wide.matrix.csv", row.names = FALSE)
...
#write as csv so that I can pull it for other scripts/analysis
write.csv(wide.park,"Output/parks.wide.matrix.csv", row.names = FALSE)
...
park.ar<- read.csv("Input/Clean_Subsite_Park_Cu.csv")
#creating a data table that sorts species codes and site code
...
#write as csv so that I can pull it for other scripts/analysis
write.csv(ar.park.w, "Output/site.park.wide.matrix.csv", row.names = FALSE)
...
#write as csv so that I can pull it for other scripts/analysis
write.csv(wide.in, "Output/in.wide.matrix.csv", row.names = FALSE)
...
in.ar<- read.csv("Input/Clean_Subsite_Inst_Cu.csv")
#creating a data table that sorts species codes and site code
...
#write as csv so that I can pull it for other scripts/analysis
write.csv(in.ar.w, "Output/site.in.wide.matrix.csv", row.names = FALSE)
...
#write as csv so that I can pull it for other scripts/analysis
write.csv(total.sp.table, "Output/allgs.matrix.csv", row.names = FALSE)
...
write.csv(site.sp.table, "Output/site.sp.table.csv", row.names = FALSE)
...
write.csv(site.sp.tot.mat, "Output/site.sp.tot.mat.csv", row.names = FALSE)
...
pie.site.means <- LMM.Meta %>%
  ...
  summarise(
    PIE.site = mean(PIE))
pie.site.means
write.csv(pie.site.means, "Output/pie.site.means.csv", row.names = FALSE)
...
ab.site.means<- LMM.Meta %>%
  ...
  summarise(
    ab.site = mean(Abund))
ab.site.means
write.csv(ab.site.means, "Output/ab.site.means.csv", row.names = FALSE)
...
sr.site.means<- LMM.Meta %>%
  ...
  summarise(
    sr.site= mean(SR))
sr.site.means
write.csv(sr.site.means, "Output/sr.site.means.csv", row.names = FALSE)
